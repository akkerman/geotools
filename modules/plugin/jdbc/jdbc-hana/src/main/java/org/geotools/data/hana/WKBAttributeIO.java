...
public class WKBAttributeIO {
     ...
     *
     * @throws java.io.IOException if more than one geometry object was found in  the
    ...
    /**
     * @see org.geotools.data.jdbc.attributeio.AttributeIO#write(java.sql.PreparedStatement, int, Object)
     */
